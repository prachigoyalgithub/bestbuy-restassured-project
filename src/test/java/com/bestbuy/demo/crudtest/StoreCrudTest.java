package com.bestbuy.demo.crudtest;

import com.bestbuy.demo.model.StorePojo;
import com.bestbuy.demo.testbase.TestBase;
import com.bestbuy.demo.testsuite.ProductAssertionTest;
import com.bestbuy.demo.utils.TestUtils;
...
public class StoreCrudTest extends TestBase {
    ...
    public void inIt() {
        ...
        ProductAssertionTest.response = given()
                .when()
                .get("/products")
                .then().statusCode(200);
    }
